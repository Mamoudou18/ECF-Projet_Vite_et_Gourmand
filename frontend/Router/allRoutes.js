...
export const allRoutes = [
    ...
    new Route("/edit-menu", "Création des menus", "./pages/menus/editMenu.html", ["admin", "employe"], "/js/menus/editMenu.js"),
    ...
    new Route("/commande", "Commande", "./pages/commandes/commande.html", ["connected"], "/js/commandes/commande.js"),
    new Route("/utilisateur", "Mon compte", "./pages/comptes/utilisateur.html", ["connected"], "/js/comptes/utilisateur.js"),
    new Route("/espace-employe", "Espace employe", "./pages/comptes/employe.html", ["admin", "employe"], "/js/comptes/employe.js"),
    new Route("/espace-administrateur", "Espace administrateur", "./pages/comptes/admin.html", ["admin"], "/js/comptes/admin.js"),
